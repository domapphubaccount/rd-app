...
export const generalSettingsSchema = z.object({
  product_purchase_code: z.coerce.number().min(1, "Required"),
  min_visit_number: z.coerce.number().min(1, "Required"),
  number_of_mobile_phones: z.coerce.number().min(1, "Required"),
  ...
  pagination_limits: z.coerce.number().min(1, "Required"),
